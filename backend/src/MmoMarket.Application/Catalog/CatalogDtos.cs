...
public record SellerSummaryDto(Guid Id, string Username, string DisplayName, string AvatarColor, double Rating, int ReviewCount, int TotalSold, string? Badge, string KycStatus);
